# -*- coding: utf-8 -*-
"""resnet101 with dice coefficient loss and without loss weight.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13BSAwKkuXMVnJsJMTa4Qp66zQmM-fzcD
"""
...
class myCallback(tf.keras.callbacks.Callback): 
    def on_epoch_end(self, epoch, logs={}): 
        ...
        if(logs.get('dice_coef') > ACCURACY_THRESHOLD ):
            ACCURACY_THRESHOLD = logs.get('dice_coef')
